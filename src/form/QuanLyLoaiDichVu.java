 ...
 * @author RavenPC
 */
public class QuanLyLoaiDichVu extends javax.swing.JPanel {
    ...
    public QuanLyLoaiDichVu() {
        ...
        row.add("1");
        row.add("Dịch vụ nghỉ dưỡng");
       
   
        model.addRow(row);
        tblLoaiDichVu.setModel(model);
        headerColor(14,142,233,tblLoaiDichVu);
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Quản Lý Loại Dịch Vụ");
        ...
        scroll.setViewportView(tblLoaiDichVu);
