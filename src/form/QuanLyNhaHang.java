 ...
 * @author RavenPC
 */
public class QuanLyNhaHang extends javax.swing.JPanel {
    ...
    public QuanLyNhaHang() {
        ...
        DefaultTableModel model = (DefaultTableModel) tblNhaHang.getModel();
        model = new DefaultTableModel(header, 0);
       
        Vector row = new Vector();
        row.add("1");
        row.add("Nhà Hàng Phương Tây");
        row.add("12/4a, Long An");
        row.add("");
    
        model.addRow(row);
        tblNhaHang.setModel(model);
        headerColor(14,142,233,tblNhaHang);
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Quản Lý Nhà Hàng");
        ...
        scroll.setViewportView(tblNhaHang);
