 ...
 * @author Hi
 */
public class popUpTour extends javax.swing.JFrame {
   
    private String action;
    private TourDTO tour;
    private ITourBLL tourBLL;
    private ILoaiDuLichBLL loaiDuLichBLL;
    public popUpTour(String action) {
        initComponents();
        myTextArea();
        this.action = action;    
        tourBLL = new TourBLL();
    ...
    public popUpTour(String action, TourDTO tour) {
        initComponents();
        myTextArea();
        this.tour = tour;
        this.action = action;    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popUpTour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
