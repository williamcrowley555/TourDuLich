 ...
 * @author Hi
 */
public class popUpGiaTour extends javax.swing.JFrame {
...
//       setComboBox(comboBoxGiaTour, getGiaTienItems(idTour,startDate));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popUpGiaTour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popUpGiaTour().setVisible(true);
            }
        });
    }
