 ...
 * @author Hi
 */
public class popUpTableDiaDiem extends javax.swing.JFrame {
    ...
    public popUpTableDiaDiem(String idTour) {
        initComponents();
        tinhBLL = new TinhBLL();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popUpTableDiaDiem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popUpTableDiaDiem().setVisible(true);
            }
        });
    }
