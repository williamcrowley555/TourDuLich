 ...
 * @author Hi
 */
public class popUpCapVaiTro extends javax.swing.JFrame {
    String[] listColumns = {
                        "Id",
                        "Họ",
                        "Tên",
    ...
    public popUpCapVaiTro(String action, DoanDTO doan) {
        initComponents(); 
        this.action = action;  
        this.doan = doan;
...
//        comboBoxTour = myComboBox(comboBoxTour, new Color(240,240,240));
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelHeader, javax.swing.GroupLayout.DEFAULT_SIZE, 714, Short.MAX_VALUE)
        ...
        if (validateForm())
        {
            ...
            if(this.action.equals("POST")) {
                try {
                    ...
                    Logger.getLogger(popUpCapVaiTro.class.getName()).log(Level.SEVERE, null, ex);
                }
                try {
                    if(save()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popUpCapVaiTro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popUpCapVaiTro().setVisible(true);
            }
        });
    }
