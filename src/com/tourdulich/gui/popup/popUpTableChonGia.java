 ...
 * @author Hi
 */
public class popUpTableChonGia extends javax.swing.JFrame {
    ...
    public popUpTableChonGia(popUpDoan popUpDoan, Long idTour, LocalDate startDate, LocalDate endDate) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popUpTableChonGia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popUpTableChonGia().setVisible(true);
            }
        });
    }
