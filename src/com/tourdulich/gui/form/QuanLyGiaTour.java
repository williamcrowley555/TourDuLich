...
import com.tourdulich.gui.popup.popUpGiaTour;
 ...
 * @author RavenPC
 */
public class QuanLyGiaTour extends javax.swing.JPanel {
    ...
    private popUpGiaTour popUp = null;
    TableRowSorter<TableModel> rowSorter = null;
    
    public QuanLyGiaTour() {
        initComponents();
    ...
    private void btnThemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMousePressed
          ...
          if (this.popUp == null) {
            this.popUp = new popUpGiaTour("POST");
